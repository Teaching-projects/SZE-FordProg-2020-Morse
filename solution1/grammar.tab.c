...
#line 137 "grammar.tab.c" /* yacc.c:355  */
};
...
{
  "$end", "error", "$undefined", "BREAK", "ROVID", "HOSSZU", "$accept",
  "E", "S", "R", "R1", "R2", "R3", "R4", "H1", YY_NULLPTR
};
#endif
